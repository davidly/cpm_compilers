...
#ifdef AZTECCPM
/*
   another exception: aztec C for CP/M, which does all char computations
   as promoted 2-byte integers with range 0-255. It's slightly faster to
   just use int and avoid the promotions.
*/
typedef int ttype;
#else
