...
char *b, p;
{
	int iintf("BDS Telnet version 2.0  (Dec. 79)\n");
	cflag= nflag= lflag= pflag = abortf= fflag = lastc = 0;
	spflag = 1;
	scount = y happen
 "÷ÅÍ
*Á!,Ã½,if the other computer has this same program
 "÷ÅÍ
*Á!Ë,Ãû,running. Do you want handshaking & checksummi